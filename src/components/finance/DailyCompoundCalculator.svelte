<script>
    ...
    function Result() {
        ...
        switch(formValues.ratePeriods){
          case "Daily":
            formValues.rate = (365 * formValues.interestRate).toFixed(2) ;
            break;
          case "Weekly":
            formValues.rate = (52 * formValues.interestRate).toFixed(2);
            break;
          case "Monthly":
            formValues.rate = (12 * formValues.interestRate).toFixed(2);
            break;
          case "Quaterly":
            formValues.rate = (4 * formValues.interestRate).toFixed(2);
            break;
          case "Yearly":
            formValues.rate = (1 * formValues.interestRate).toFixed(2);
            break;
          ...
          <div class="col-md-4">
            <div class="card" >
                    <div class="card-header">
                      <h3 class="card-title">Daily Compound Calculator</h3>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                  <div class="col-6">
                                      ...
                                      <div class="input-icon mb-3">
                                          <input type="number" bind:value={formValues.interestRate} min="0" class="form-control" placeholder="Interest Rate">
                                  ...
                                  <div class="col-6">
                                      <label class="form-label" for="compound">Period</label>
                                      <select name="user" bind:value={formValues.ratePeriods}  class="form-select" >
