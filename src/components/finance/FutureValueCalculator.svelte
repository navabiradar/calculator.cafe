<script>
    ...
    function ClientPrint() {
      printJS({ printable: 'result-print', type: 'html', header: 'calculator.cafe | Future Value Calculator' })
    }
    
    function Result() {
        formValues.result = finance.FV(formValues.rate, formValues.initialAmount, formValues.periods);
          ...
          <div class="col-md-4">
            <div class="card" >
                            ...
                            <div class="row">
                                  <div class="col-6">
                                      ...
                                      <div class="input-icon mb-3">
                                          <input type="number"   min="0" class="form-control" bind:value={formValues.rate} placeholder="Interest Rate">
                                  ...
                                  <div class="col-6">
                                      ...
                                      <div class="input-group mb-2">
                                        <input type="number"  bind:value={ formValues.periods }  min="0" class="form-control" placeholder="Period">
                    ...
                    <div class="card-footer text-end">
                      ...
                      <a type="submit" on:click={ () => { Result() } } class="btn btn-primary">Submit</a>
                    </div>
                  </div>
                          ...
                          <div class="row">
                              ...
                              <div class="col-4">
                                  ...
                                  <div class="input-group mb-2">
                                    ...
                                    <p class ="page-title" >{formValues.interestEarned}</p>
                                  </div>
                              </div>
                              <div class="col-4">
