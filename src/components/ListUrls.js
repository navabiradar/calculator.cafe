...
export const urlsLists = 
    { 
        ...
        },
        {
            ...
            url: "/finance/cagr-calculator",
            status: false,
        },
        {
            name: "National Pension System(NPS) Calculator",
            url: "/finance/nps-calculator",
            status: false,
        },
        {
            name: "Interest Calculator",
            url: "/finance/interest-calculator",
            status: false,
        },
        {
            name: "Payment Calculator",
            url: "/finance/payment-calculator",
            status: false,
        },
        {
        ...
        {
            name: "Stepup SIP Calculator",
            url: "/finance/stepup-sip-calculator",
            status: false,
        },
        {
            name: "Systematic Withdrawal Plan (SWP) Calculator",
            url: "/finance/swp-calculator",
            status: false,
        },
        {
        ...
        },
        {
            ...
            url: "/finance/home-loan-calculator",
            status: false,
        },
        {
            name: "Personal Loan Calculator",
            url: "/finance/personal-loan-calculator",
            status: false,
        },
        {
        ...
        },
        {
            ...
            url: "/finance/auto-loan-calculator",
            status: false,
        },
        {
