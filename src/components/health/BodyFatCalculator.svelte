        ...
        <div class="card" >
                ...
                <div class="card-body">
                  <div class="mb-3">
                    ...
                    <div class="mb-3">
                              <label class="form-label page-title text-uppercase" for="">Body Fat:&nbsp{ formValues.result }&nbsp %</label>
